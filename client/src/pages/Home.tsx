/* ═══════════════════════════════════════════════
   ...
   v5.0 — 7-Section Framework + Detail Page Planner
   ═══════════════════════════════════════════════ */
   ...
   import DetailPagePlanner from "@/components/DetailPagePlanner";
     ...
     return (
       <div className="min-h-screen bg-background">
         ...
         <main className="container max-w-6xl mx-auto px-4 pb-24">
           ...
           {/* Step 3 + 4: Storyboard, Prompts, Checklist, Detail Page Planner */}
           {step === 'storyboard' && storyboard && (
             <>
               ...
               {/* Step 3 Checklist: Phase 1~4 + Reject Criteria */}
               <ChecklistPanel category={category!} />
   
               {/* ✅ Step 4: 상세페이지 기획 플래너 (NEW v5.0) */}
               <DetailPagePlanner
                 category={category!}
                 productName={productName}
                 platform={platform}
               ...
               <div className="mt-16 text-center">
                 <button
                   onClick={handleReset}
                   className="px-8 py-3 font-medium rounded-lg transition-colors bg-muted hover:bg-muted/80 text-foreground"
                 >
                   새 프로젝트 시작하기
                 </button>
               </div>
